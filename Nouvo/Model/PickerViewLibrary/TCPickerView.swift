...
open class TCPickerView: UIView, UITableViewDataSource, UITableViewDelegate, TCPickerViewInput {
    ...
    @objc private func close() {
        ...
        NotificationCenter.default.post(name: NSNotification.Name(rawValue: "CloseBackgroundview1"), object: nil)
        NotificationCenter.default.post(name: NSNotification.Name(rawValue: "CloseBackgroundview2"), object: nil)
