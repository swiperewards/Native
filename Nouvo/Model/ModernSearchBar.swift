...
public class ModernSearchBar: UISearchBar, UISearchBarDelegate, UITableViewDataSource, UITableViewDelegate {
    ...
    public var suggestionsShadow: UIView!
    ...
    private func configureViews(){
        ...
        self.suggestionsView = UITableView(frame: CGRect(x: getSuggestionsViewX(), y: getSuggestionsViewY()+10, width: getSuggestionsViewWidth() , height: 0))
        ...
        self.suggestionsView.layer.borderColor = UIColor.lightGray.cgColor
        self.suggestionsView.layer.borderWidth = 1.0;
        ...
        self.suggestionsShadow = UIView(frame: CGRect(x: getShadowX(), y: getShadowY()+10, width: getShadowWidth(), height: getShadowHeight()))
        ...
        self.suggestionsView.separatorColor = UIColor.lightGray
        self.suggestionsView.separatorInset.right = 20
    ...
    // when you type anything in search bar , its calling here first
    ...
    public func searchBarTextDidBeginEditing(_ searchBar: UISearchBar) {
        ...
        self.suggestionListFiltred.append(contentsOf: suggestionList)
        self.suggestionsView.reloadData()
    ...
    //First calling here when you touch search bar
...
//    }
    ...
    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
       ...
       // let view = UIView(frame: CGRect(x: 5, y: 5, width: 300, height: <#T##CGFloat#>))
        ...
        cell.configureWidthMaxLabel(suggestionsViewWidth: self.suggestionsView.frame.width-10, searchImageWidth: self.suggestionsView_searchIcon_width)
    ...
    public func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        case .normal:
            ...
            //Constants.cityname = self.suggestionListFiltred[indexPath.row]
    ...
    private func closeSuggestionsView(){
        ...
        if (self.isSuggestionsViewOpened == true){
           ...
           // self.suggestionsView.frame = CGRect(x: 0, y: self.getGlobalPointEditText().y, width: 0, height: 0)
            self.isSuggestionsViewOpened = false
        }
    }
    ...
    private func getShadowY() -> CGFloat {
        ...
        print("Y axis : ",self.getGlobalPointEditText().y)
        print(" Height is :",self.getEditText().frame.height)
    ...
    private func updateSizeSuggestionsView(){
       ...
       // self.suggestionsView.frame.origin.y = self.getGlobalPointEditText().y
